    ...
    var d = function () {
        ...
        return _createClass(c, [{
            ...
            key: "createDiacriticsRegExp", value: function (a) {
                var b = ["aÀÁÂÃÄÅàáâãäåĀāąĄ", "cÇçćĆčČ", "dđĐďĎ", "eÈÉÊËèéêëěĚĒēęĘ", "iÌÍÎÏìíîïĪī", "lłŁ", "nÑñňŇńŃ", "oÒÓÔÕÕÖØòóôõöøŌō", "rřŘ", "sŠšśŚ", "tťŤ", "uÙÚÛÜùúûüůŮŪū", "yŸÿýÝ", "zŽžżŻźŹ"], c = [];
            ...
            key: "createAccuracyRegExp", value: function (a) {
                var b = this, c = this.opt.accuracy, d = "string" == typeof c ? c : c.value, e = "string" == typeof c ? [] : c.limiters, f = "";
            ...
            key: "matchesExclude", value: function (a, b) {
                var c = this, d = !0, e = this.opt.exclude.concat(["script", "style", "title"]);
            ...
            key: "forEachElement", value: function (a) {
                ...
                } : arguments[1], d = arguments.length <= 2 || void 0 === arguments[2] ? !0 : arguments[2], e = this.getElements(), f = e.elements, g = e.length, h = function () {
                    0 === --g && c()
                };
            ...
            key: "wrapMatches", value: function (a, c, d, e, f) {
                for (var g = this.opt.element ? this.opt.element : "mark", h = d ? 0 : 2, i = void 0; null !== (i = c.exec(a.textContent));)if (e(i[h])) {
                    var j = i.index;
                    d || (j += i[h - 1].length);
                    var k = a.splitText(j);
            ...
            key: "mark", value: function (a, b) {
                var c = this;
                this.opt = b;
                var d = this.getSeparatedKeywords("string" == typeof a ? [a] : a), e = d.keywords, f = d.length, g = 0;
                0 === f && this.opt.done(g), e.forEach(function (a) {
                    var b = new RegExp(c.createRegExp(a), "gmi"), d = 0, h = function (a) {
                        d++, g++, c.opt.each(a)
                    };
...
$(function () {
    ...
    /** Input search **/
    var $searchButton = $('nav#menu-principal button'),
        $searchInput = $('nav#menu-principal input');

    $searchButton.on("click", function (e) {

        if ($searchInput.hasClass('active')) {
            if (!$searchInput.val()) e.preventDefault();
            $searchInput.fadeOut().removeClass('active');
        }
        else {
            e.preventDefault();
            $searchInput.fadeIn().addClass('active');

        }
    });

    /** Anti spam **/
    var $commentForm = $('textarea#content');

    $commentForm.attr('disabled', true);
    var i = 8;
    var antispam = setInterval(function () {
        i--;
        $commentForm.html('Attendez encore ' + i + ' seconde(s) avant de commenter');
        if (i == 0) {
