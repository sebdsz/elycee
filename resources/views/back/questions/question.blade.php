...
@section('content')
    ...
    @else
        ...
        @foreach($question->choices as $index => $choice)
            <div class="question">
                <div class="form-group">
                    ...
                    <input {{ \App\Helpers\Check::isChecked(Session::get('checked'), $index) }} disabled type="checkbox" value="1">
                    <span>
        ...
        @endforeach
        <p>Vous avez répondu en {{ Session::get('timer') }} secondes.</p>
        <p>Votre score est de : {{ Session::get('note') }}/{{ Session::get('max') }}</p>
