    ...
    <form action="{{ action('StudentController@update', $student) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="role" id="role" required>
                <option value="first_class" @if($student->role === 'first_class') selected @endif>Première S</option>
                <option value="final_class" @if($student->role === 'final_class') selected @endif>Terminale S</option>
            </select>
